...
//        double realRightObs[3][3] = {{1, 3, 0.25}, {1, 6, 0.25}, {1, 9, 0.25}};
    ...
    double realLeftObs[3][3] = {{-0.0250001, 1.7375 - 0.5, 0.353774}, {-0.435825, 2.52891, 0.257694}, {-0.237949, 4.04323, 0.285318}};
    double realRightObs[3][3] = {{1.4408, 2.2066 - 0.5, 0.290743}, {1.577, 3.41446, 0.251558}, {1.5515, 4.56942, 0.313249}};
