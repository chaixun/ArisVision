#include "Vision_AvoidControl1.h"
...
void AvoidControl::AvoidWalkControl(RobPose targetPose, RobPose cRobotPos, vector<ObsPose> cObstaclePoses)
{
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    virtualObs.y = currentObs.y;
                    virtualObs.r = 0.3;
                    lObsPoses.push_back(virtualObs);
                }
                WalkAngel += (0.5 + robWalkNum - 1) * robTurnAngel;
            }
        }
